...
(function (jcast) {
    var Renderer = /** @class */ (function () {
        ...
        Renderer.prototype.render = function () {
            ...
            var xl = this._step.x * activeCamera.farClipPlane;
            var yl = this._step.y * activeCamera.farClipPlane;
            var sa = activeCamera.transform.rotation.y + jcast.Mathf.HALF_PI;
            var fs = this._fov / this.width;
            var sx = Math.cos(sa) * fs; // TODO: multiply by Field Step
            var sy = Math.sin(sa) * fs; // TODO: multiply by Field Step
            var hw = this._fov / 2;
            ...
            for (var fx = 0; fx < this._fov; fx += fs) {
                ...
                if (oxi == txi && oyi == tyi) {
                    ...
                    do {
                        ...
                        var xi = Math.floor(this._target.x);
                        var yi = Math.floor(this._target.y);
                        ...
                        // (It seems OK though)
                        if ((ddaxs == -1 && this._target.x == oxip1 && yi == oyi) ||
