...
(function (jcast) {
    var Block = /** @class */ (function (_super) {
        ...
        Block.prototype.render = function (renderer, fx, isClosestTarget, hit, origin, step, target) {
            /**
...
(function (jcast) {
    var Renderer = /** @class */ (function () {
        ...
        Renderer.prototype.render = function () {
            ...
            var ox = activeCamera.transform.position.x + (Math.cos(activeCamera.transform.rotation.y - jcast.Mathf.HALF_PI) * (this._fov / 2));
            var oy = activeCamera.transform.position.y + (Math.sin(activeCamera.transform.rotation.y - jcast.Mathf.HALF_PI) * (this._fov / 2));
            ...
            var tx = ox + xl;
            var ty = oy + yl;
            var xs = Math.cos(activeCamera.transform.rotation.y + jcast.Mathf.HALF_PI);
            var ys = Math.sin(activeCamera.transform.rotation.y + jcast.Mathf.HALF_PI);
            var hd = ox - tx;
            var vd = oy - ty;
            ...
            //
            for (var f = 0; f < this._fov; f += 1) {
                // Draw line from target to origin:
                this._context.strokeStyle = 'rgba(0, 255, 0, 0.5)';
                (_c = this._context) === null || _c === void 0 ? void 0 : _c.beginPath();
                (_d = this._context) === null || _d === void 0 ? void 0 : _d.moveTo(tx, ty);
                (_e = this._context) === null || _e === void 0 ? void 0 : _e.lineTo(ox, oy);
                (_f = this._context) === null || _f === void 0 ? void 0 : _f.stroke();
                //
                ox += xs;
                oy += ys;
                tx += xs;
            ...
            (_g = this._context) === null || _g === void 0 ? void 0 : _g.beginPath();
            (_h = this._context) === null || _h === void 0 ? void 0 : _h.moveTo(activeCamera.transform.position.x, activeCamera.transform.position.y);
            (_j = this._context) === null || _j === void 0 ? void 0 : _j.lineTo(activeCamera.transform.position.x + (Math.cos(activeCamera.transform.rotation.y) * activeCamera.farClipPlane), activeCamera.transform.position.y + (Math.sin(activeCamera.transform.rotation.y) * activeCamera.farClipPlane));
            (_k = this._context) === null || _k === void 0 ? void 0 : _k.stroke();
            //
            // Draw camera point:
            var cw = 3;
            var ch = 3;
            this.context.fillStyle = 'blue';
            (_l = this.context) === null || _l === void 0 ? void 0 : _l.fillRect(activeCamera.transform.position.x - (cw / 2), activeCamera.transform.position.y - (ch / 2), cw, ch);
            //
            // Draw directions steps:
            this._context.font = '16px Arial Bold';
            (_m = this._context) === null || _m === void 0 ? void 0 : _m.fillText("XD: " + xd + " YD: " + yd, 20, 20);
            //
