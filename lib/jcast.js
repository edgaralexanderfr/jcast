...
(function (jcast) {
    var Renderer = /** @class */ (function () {
        ...
        Renderer.prototype.render = function () {
            ...
            this._origin.x = activeCamera.transform.position.x + (Math.cos(activeCamera.transform.rotation.y - jcast.Mathf.HALF_PI) * (this._fov / 2));
            this._origin.y = activeCamera.transform.position.y + (Math.sin(activeCamera.transform.rotation.y - jcast.Mathf.HALF_PI) * (this._fov / 2));
            ...
            var tx = this._origin.x + xl;
            var ty = this._origin.y + yl;
            var fs = this._fov / this._width;
            var xs = Math.cos(activeCamera.transform.rotation.y + jcast.Mathf.HALF_PI) * fs;
            var ys = Math.sin(activeCamera.transform.rotation.y + jcast.Mathf.HALF_PI) * fs;
            ...
            //
            for (var fx = 0; fx < this._fov; fx += fs) {
                ...
                if (oxi == txi && oyi == tyi) {
                    ...
                    this._target.x = tx;
                    this._target.y = ty;
                    block === null || block === void 0 ? void 0 : block.render(this, fx, true, false, this._origin, this._step, this._target);
                }
                else {
                    if (xd == -1 || xd == 1) {
                        if (xd == -1) {
                    ...
                    do {
                        ...
                        block === null || block === void 0 ? void 0 : block.render(this, fx, false, true, this._origin, this._step, this._target);
                    } while (true);
                    block === null || block === void 0 ? void 0 : block.render(this, fx, true, true, this._origin, this._step, this._target);
                }
