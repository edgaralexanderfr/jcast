...
(function (jcast) {
    var Block = /** @class */ (function (_super) {
        ...
        Block.prototype.render = function (renderer, c, sx, sy, dx, dy, side) {
            var _a, _b;
            ...
            var mx = this.transform.position.x;
            var my = this.transform.position.y;
            var distance = (side == 0) ? (mx - x + (1 - sx) / 2) / dx : (my - y + (1 - sy) / 2) / dy;
            var height = Math.floor(map.depth * renderer.height / distance);
            var wy = Math.floor((renderer.height - height) / 2);
...
(function (jcast) {
    var Map = /** @class */ (function () {
        function Map(_a) {
            var _b = _a === void 0 ? {} : _a, _c = _b.camera, camera = _c === void 0 ? undefined : _c, _d = _b.width, width = _d === void 0 ? 64 : _d, _e = _b.height, height = _e === void 0 ? 64 : _e, _f = _b.depth, depth = _f === void 0 ? 1 : _f, _g = _b.name, name = _g === void 0 ? undefined : _g;
            this._width = 0;
            this._height = 0;
            this._depth = 0.0;
            this._blocks = [];
